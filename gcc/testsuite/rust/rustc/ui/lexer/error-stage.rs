...
fn main() {
    "string"any_suffix; // { dg-error "" "" { target *-*-* } }
    10u123; // { dg-error "" "" { target *-*-* } }
    10.0f123; // { dg-error "" "" { target *-*-* } }
    0b10f32; // { dg-error "" "" { target *-*-* } }
    0b10.0f32; // { dg-error "" "" { target *-*-* } }
    999340282366920938463463374607431768211455999; // { dg-error "" "" { target *-*-* } }
}
