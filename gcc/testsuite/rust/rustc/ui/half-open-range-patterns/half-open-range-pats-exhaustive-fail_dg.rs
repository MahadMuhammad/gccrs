...
fn floats() {
    m!(0f32, f32::NEG_INFINITY..); // { dg-error ".E0004." "" { target *-*-* } }
    m!(0f32, ..f32::INFINITY); // { dg-error ".E0004." "" { target *-*-* } }
}
...
mod unsigned {
    fn u8() {
        ...
        m!(0, ..u8::MAX); // { dg-error ".E0004." "" { target *-*-* } }
    ...
    fn u16() {
        ...
        m!(0, ..u16::MAX); // { dg-error ".E0004." "" { target *-*-* } }
        m!(0, ..ALMOST_MAX); // { dg-error ".E0004." "" { target *-*-* } }
        m!(0, ALMOST_MIN..); // { dg-error ".E0004." "" { target *-*-* } }
        m!(0, ..=ALMOST_MAX); // { dg-error ".E0004." "" { target *-*-* } }
        m!(0, ..=VAL | VAL_2..); // { dg-error ".E0004." "" { target *-*-* } }
    ...
    fn u32() {
        ...
        m!(0, ..u32::MAX); // { dg-error ".E0004." "" { target *-*-* } }
        m!(0, ..ALMOST_MAX); // { dg-error ".E0004." "" { target *-*-* } }
        m!(0, ALMOST_MIN..); // { dg-error ".E0004." "" { target *-*-* } }
        m!(0, ..=ALMOST_MAX); // { dg-error ".E0004." "" { target *-*-* } }
        m!(0, ..=VAL | VAL_2..); // { dg-error ".E0004." "" { target *-*-* } }
    ...
    fn u64() {
        ...
        m!(0, ..u64::MAX); // { dg-error ".E0004." "" { target *-*-* } }
        m!(0, ..ALMOST_MAX); // { dg-error ".E0004." "" { target *-*-* } }
        m!(0, ALMOST_MIN..); // { dg-error ".E0004." "" { target *-*-* } }
        m!(0, ..=ALMOST_MAX); // { dg-error ".E0004." "" { target *-*-* } }
        m!(0, ..=VAL | VAL_2..); // { dg-error ".E0004." "" { target *-*-* } }
    ...
    fn u128() {
        ...
        m!(0, ..u128::MAX); // { dg-error ".E0004." "" { target *-*-* } }
        m!(0, ..ALMOST_MAX); // { dg-error ".E0004." "" { target *-*-* } }
        m!(0, ALMOST_MIN..); // { dg-error ".E0004." "" { target *-*-* } }
        m!(0, ..=ALMOST_MAX); // { dg-error ".E0004." "" { target *-*-* } }
        m!(0, ..=VAL | VAL_2..); // { dg-error ".E0004." "" { target *-*-* } }
...
mod signed {
    fn i8() {
        ...
        m!(0, ..i8::MAX); // { dg-error ".E0004." "" { target *-*-* } }
        m!(0, ..ALMOST_MAX); // { dg-error ".E0004." "" { target *-*-* } }
        m!(0, ALMOST_MIN..); // { dg-error ".E0004." "" { target *-*-* } }
        m!(0, ..=ALMOST_MAX); // { dg-error ".E0004." "" { target *-*-* } }
        m!(0, ..=VAL | VAL_2..); // { dg-error ".E0004." "" { target *-*-* } }
    ...
    fn i16() {
        ...
        m!(0, ..i16::MAX); // { dg-error ".E0004." "" { target *-*-* } }
        m!(0, ..ALMOST_MAX); // { dg-error ".E0004." "" { target *-*-* } }
        m!(0, ALMOST_MIN..); // { dg-error ".E0004." "" { target *-*-* } }
        m!(0, ..=ALMOST_MAX); // { dg-error ".E0004." "" { target *-*-* } }
        m!(0, ..=VAL | VAL_2..); // { dg-error ".E0004." "" { target *-*-* } }
    ...
    fn i32() {
        ...
        m!(0, ..i32::MAX); // { dg-error ".E0004." "" { target *-*-* } }
        m!(0, ..ALMOST_MAX); // { dg-error ".E0004." "" { target *-*-* } }
        m!(0, ALMOST_MIN..); // { dg-error ".E0004." "" { target *-*-* } }
        m!(0, ..=ALMOST_MAX); // { dg-error ".E0004." "" { target *-*-* } }
        m!(0, ..=VAL | VAL_2..); // { dg-error ".E0004." "" { target *-*-* } }
    ...
    fn i64() {
        ...
        m!(0, ..i64::MAX); // { dg-error ".E0004." "" { target *-*-* } }
        m!(0, ..ALMOST_MAX); // { dg-error ".E0004." "" { target *-*-* } }
        m!(0, ALMOST_MIN..); // { dg-error ".E0004." "" { target *-*-* } }
        m!(0, ..=ALMOST_MAX); // { dg-error ".E0004." "" { target *-*-* } }
        m!(0, ..=VAL | VAL_2..); // { dg-error ".E0004." "" { target *-*-* } }
    ...
    fn i128() {
        ...
        m!(0, ..i128::MAX); // { dg-error ".E0004." "" { target *-*-* } }
        m!(0, ..ALMOST_MAX); // { dg-error ".E0004." "" { target *-*-* } }
        m!(0, ALMOST_MIN..); // { dg-error ".E0004." "" { target *-*-* } }
        m!(0, ..=ALMOST_MAX); // { dg-error ".E0004." "" { target *-*-* } }
        m!(0, ..=VAL | VAL_2..); // { dg-error ".E0004." "" { target *-*-* } }
