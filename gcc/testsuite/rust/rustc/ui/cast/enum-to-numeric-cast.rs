...
fn main() {
    ...
    let _ = not_unit_only_or_fieldless as isize; // { dg-error ".E0605." "" { target *-*-* } }
    let _ = not_unit_only_or_fieldless as i32; // { dg-error ".E0605." "" { target *-*-* } }
    let _ = not_unit_only_or_fieldless as usize; // { dg-error ".E0605." "" { target *-*-* } }
    let _ = not_unit_only_or_fieldless as u32; // { dg-error ".E0605." "" { target *-*-* } }
}
