...
#[must_use] // { dg-warning "" "" { target *-*-* } }
mod must_use {
    mod inner { #![must_use] } // { dg-warning "" "" { target *-*-* } }

    #[must_use] fn f() { }

    #[must_use] struct S;

    #[must_use] type T = S; // { dg-warning "" "" { target *-*-* } }

    #[must_use] impl S { } // { dg-warning "" "" { target *-*-* } }
}
