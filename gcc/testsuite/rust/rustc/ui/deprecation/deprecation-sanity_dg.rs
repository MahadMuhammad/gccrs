...
mod bogus_attribute_types_1 {
    ...
    #[deprecated(since = "a", note)] // { dg-error ".E0539." "" { target *-*-* } }
    fn f2() { }

    #[deprecated(since, note = "a")] // { dg-error ".E0539." "" { target *-*-* } }
    fn f3() { }

    #[deprecated(since = "a", note(b))] // { dg-error ".E0539." "" { target *-*-* } }
    fn f5() { }

    #[deprecated(since(b), note = "a")] // { dg-error ".E0539." "" { target *-*-* } }
    fn f6() { }
...
#[deprecated(since = "a", note = "b")] // { dg-error "" "" { target *-*-* } }
fn multiple1() { }
