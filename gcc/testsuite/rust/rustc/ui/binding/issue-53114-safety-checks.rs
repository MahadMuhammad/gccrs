...
fn let_wild_gets_unsafe_field() {
    ...
    let u2 = U { a: I(1) };
    let p = P { a: &2, b: &3 };
    let _ = &p.b;  // { dg-error ".E0793." "" { target *-*-* } }
...
fn let_ascribe_gets_unsafe_field() {
    ...
    let u2 = U { a: I(1) };
    let p = P { a: &2, b: &3 };
    let _: _ = &p.b;  // { dg-error ".E0793." "" { target *-*-* } }
    let _: _ = u1.a;  // { dg-error ".E0133." "" { target *-*-* } }
    let _: _ = &u2.a; // { dg-error ".E0133." "" { target *-*-* } }
...
fn match_unsafe_field_to_wild() {
    ...
    let u2 = U { a: I(1) };
    let p = P { a: &2, b: &3 };
    match &p.b  { _ => { } } // { dg-error ".E0793." "" { target *-*-* } }
