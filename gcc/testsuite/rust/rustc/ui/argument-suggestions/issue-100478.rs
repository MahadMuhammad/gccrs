...
fn main() {
    three_diff(T2::new(0)); // { dg-error ".E0061." "" { target *-*-* } }
    four_shuffle(T3::default(), T4::default(), T1::default(), T2::default()); // { dg-error ".E0308." "" { target *-*-* } }
    four_shuffle(T3::default(), T2::default(), T1::default(), T3::default()); // { dg-error ".E0308." "" { target *-*-* } }
