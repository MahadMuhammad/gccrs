...
#[no_mangle]
pub extern "C" fn bar<T>() {} // { dg-error "" "" { target *-*-* } }
...
impl Trait1 for Foo {
    #[no_mangle]
    fn foo<T>() {} // { dg-error "" "" { target *-*-* } }

    #[no_mangle]
    extern "C" fn bar<T>() {} // { dg-error "" "" { target *-*-* } }
...
impl<T> Trait2<T> for Foo {
    ...
    #[no_mangle]
    fn foo2<U>() {} // { dg-error "" "" { target *-*-* } }

    #[no_mangle]
    extern "C" fn bar() {} // { dg-error "" "" { target *-*-* } }

    #[no_mangle]
    fn baz(x: &i32) -> &i32 { x } // { dg-error "" "" { target *-*-* } }

    #[no_mangle]
    fn qux<'a>(x: &'a i32) -> &i32 { x } // { dg-error "" "" { target *-*-* } }
}
...
impl<T> Bar<T> {
    ...
    #[no_mangle]
    pub extern "C" fn bar() {} // { dg-error "" "" { target *-*-* } }

    #[no_mangle]
    pub fn baz<U>() {} // { dg-error "" "" { target *-*-* } }
}
