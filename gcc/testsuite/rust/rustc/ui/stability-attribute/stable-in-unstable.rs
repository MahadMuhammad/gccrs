...
mod isolated1 {
    use stable_in_unstable_core::new_unstable_module; // { dg-error ".E0658." "" { target *-*-* } }
    use stable_in_unstable_core::new_unstable_module::OldTrait; // { dg-error ".E0658." "" { target *-*-* } }
}
...
mod isolated4 {
    ...
    impl stable_in_unstable_core::new_unstable_module::OldTrait for LocalType {} // { dg-error ".E0658." "" { target *-*-* } }
}
