...
mod types {
    ...
    pub type Alias = Priv; // { dg-error "" "" { target *-*-* } }
    pub enum E {
        V1(Priv), // { dg-error "" "" { target *-*-* } }
        V2 { field: Priv }, // { dg-error "" "" { target *-*-* } }
    }
    pub trait Tr {
        const C: Priv = Priv; // { dg-error "" "" { target *-*-* } }
        type Alias = Priv; // { dg-error ".E0446." "" { target *-*-* } }
        fn f1(arg: Priv) {} // { dg-error "" "" { target *-*-* } }
        fn f2() -> Priv { panic!() } // { dg-error "" "" { target *-*-* } }
    }
    extern "C" {
        pub static ES: Priv; // { dg-error "" "" { target *-*-* } }
        pub fn ef1(arg: Priv); // { dg-error "" "" { target *-*-* } }
        pub fn ef2() -> Priv; // { dg-error "" "" { target *-*-* } }
    }
    impl PubTr for Pub {
        type Alias = Priv; // { dg-error ".E0446." "" { target *-*-* } }
    }
...
mod aliases_pub {
    ...
    impl PrivAlias {
        pub fn f(arg: Priv) {} // { dg-error "" "" { target *-*-* } }
    }
