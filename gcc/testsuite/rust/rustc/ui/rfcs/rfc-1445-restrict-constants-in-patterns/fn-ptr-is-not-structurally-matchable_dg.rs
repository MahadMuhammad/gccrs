...
fn main() {
    ...
    match Wrap(input) {
        Wrap(CFN1) => count += 1, // { dg-error "" "" { target *-*-* } }
        Wrap(_) => {}
    };
    ...
    match Wrap(input) {
        Wrap(CFN2) => count += 1, // { dg-error "" "" { target *-*-* } }
        Wrap(_) => {}
    };
    ...
    match Wrap(input) {
        Wrap(CFN3) => count += 1, // { dg-error "" "" { target *-*-* } }
        Wrap(_) => {}
    };
    ...
    match Wrap(input) {
        Wrap(CFN4) => count += 1, // { dg-error "" "" { target *-*-* } }
        Wrap(_) => {}
    };
    ...
    match Wrap(input) {
        Wrap(CFN5) => count += 1, // { dg-error "" "" { target *-*-* } }
        Wrap(_) => {}
    };
    ...
    match Wrap(input) {
        Wrap(CFN6) => count += 1, // { dg-error "" "" { target *-*-* } }
        Wrap(_) => {}
    };
    ...
    match Wrap(input) {
        Wrap(CFN7) => count += 1, // { dg-error "" "" { target *-*-* } }
        Wrap(_) => {}
    };
    ...
    match Wrap(input) {
        Wrap(CFN8) => count += 1, // { dg-error "" "" { target *-*-* } }
        Wrap(_) => {}
    };
    ...
    match Wrap(input) {
        Wrap(CFN9) => count += 1, // { dg-error "" "" { target *-*-* } }
        Wrap(_) => {}
    };
