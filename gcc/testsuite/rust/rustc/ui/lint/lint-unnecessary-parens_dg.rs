...
pub fn parens_with_keyword(e: &[()]) -> i32 {
    ...
    for _ in(e) {} // { dg-error "" "" { target *-*-* } }
    match(1) { _ => ()} // { dg-error "" "" { target *-*-* } }
    return(1); // { dg-error "" "" { target *-*-* } }
}
...
fn main() {
    ...
    let(mut _a) = 3; // { dg-error "" "" { target *-*-* } }
    let (mut _a) = 3; // { dg-error "" "" { target *-*-* } }
    let( mut _a) = 3; // { dg-error "" "" { target *-*-* } }

    let(_a) = 3; // { dg-error "" "" { target *-*-* } }
    let (_a) = 3; // { dg-error "" "" { target *-*-* } }
    let( _a) = 3; // { dg-error "" "" { target *-*-* } }
    ...
    let mut x = 0;
    let _r = (&x); // { dg-error "" "" { target *-*-* } }
    let _r = (&mut x); // { dg-error "" "" { target *-*-* } }
    let _r = (&raw const x);
    let _r = (&raw mut x);
}
