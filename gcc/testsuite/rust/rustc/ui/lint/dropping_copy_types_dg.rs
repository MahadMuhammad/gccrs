...
fn main() {
    ...
    drop(s1); // { dg-warning "" "" { target *-*-* } }
    drop(s2); // { dg-warning "" "" { target *-*-* } }
    drop(s3); // { dg-warning "" "" { target *-*-* } }
    drop(s4); // { dg-warning "" "" { target *-*-* } }
    drop(s5); // { dg-warning "" "" { target *-*-* } }
    ...
    drop(a2); // { dg-warning "" "" { target *-*-* } }
    drop(a3);
    drop(a4); // { dg-warning "" "" { target *-*-* } }
    drop(a5);
}
