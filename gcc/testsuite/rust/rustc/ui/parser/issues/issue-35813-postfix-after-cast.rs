...
pub fn cast_cast_method_call() {
    let _ = 0i32: i32: i32.count_ones(); // { dg-error "" "" { target *-*-* } }
}

pub fn cast_cast_method_call_2() {
    let _ = 0 as i32: i32.count_ones(); // { dg-error "" "" { target *-*-* } }
}

pub fn cast_cast_method_call_3() {
    let _ = 0i32: i32 as i32.count_ones(); // { dg-error "" "" { target *-*-* } }
}
...
pub fn cast_cast_method_call_5() {
    let _ = 0i32: i32: i32 as u32 as i32.count_ones(); // { dg-error "" "" { target *-*-* } }
}

pub fn cast_cast_method_call_6() {
    let _ = 0i32: i32.count_ones(): u32; // { dg-error "" "" { target *-*-* } }
}

pub fn cast_cast_method_call_7() {
    let _ = 0 as i32.count_ones(): u32; // { dg-error "" "" { target *-*-* } }
// { dg-error "" "" { target *-*-* } .-1 }
}

pub fn cast_cast_method_call_8() {
    let _ = 0i32: i32.count_ones() as u32; // { dg-error "" "" { target *-*-* } }
}
...
pub fn cast_cast_method_call_10() {
    let _ = 0i32: i32: i32.count_ones() as u32 as i32; // { dg-error "" "" { target *-*-* } }
}
