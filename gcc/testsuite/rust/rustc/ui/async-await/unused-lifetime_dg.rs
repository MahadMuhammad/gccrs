...
async fn async_wrong_without_args<'a>() {} // { dg-error "" "" { target *-*-* } }

async fn async_wrong_1_lifetime<'a>(_: &i32) {} // { dg-error "" "" { target *-*-* } }

async fn async_wrong_2_lifetimes<'a, 'b>(_: &'a i32, _: &i32) {} // { dg-error "" "" { target *-*-* } }
...
fn wrong_without_args<'a>() {} // { dg-error "" "" { target *-*-* } }

fn wrong_1_lifetime<'a>(_: &i32) {} // { dg-error "" "" { target *-*-* } }

fn wrong_2_lifetimes<'a, 'b>(_: &'a i32, _: &i32) {} // { dg-error "" "" { target *-*-* } }
